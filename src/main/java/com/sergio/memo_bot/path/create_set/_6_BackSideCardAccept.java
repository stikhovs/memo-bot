...
import static com.sergio.memo_bot.state.UserStateType.BACK_SIDE_CARD_ACCEPT;
    ...
    public BotReply process(ProcessableMessage processableMessage) {
        ...
        return BotReply.builder()
                ...
                .nextReply(BotReply.builder()
                        ...
                        .replyMarkup(
                                MarkUpUtil.getInlineKeyboardMarkup(List.of(
                                        Pair.of(EmojiConverter.getEmoji("U+2705") + " Добавить еще одну", CommandType.ADD_CARD_REQUEST),
