...
public final class ReplyTextConstant {
    ...
    public static final String MAIN_MENU = """
            ...
            1. <strong>Категории</strong> — создавайте категории и добавляйте в них наборы карточек. Пример: категория "Английский язык"
                        
            2. <strong>Наборы карточек</strong> — основа вашего обучения и прогресса. С помощью наборов вы можете учить, повторять и вспоминать неограниченное количество слов, определений, дат или терминов. Создавайте наборы и используйте их в упражнениях. Пример набора: "Приветствия"
